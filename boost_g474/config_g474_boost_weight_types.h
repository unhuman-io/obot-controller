#ifndef UNHUMAN_BOOST_G474_CONFIG_G474_BOOST_WEIGHT_TYPES_H_
#define UNHUMAN_BOOST_G474_CONFIG_G474_BOOST_WEIGHT_TYPES_H_

// === Necessary for weight (instance). ===
...
#endif  // UNHUMAN_BOOST_G474_CONFIG_G474_BOOST_WEIGHT_TYPES_H_