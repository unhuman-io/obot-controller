...
const volatile Param initial_param = {
    ...
    .fast_loop_param.adc1_gain = 3.0/4096/(.2), //3.3/4096*(.2),  hall // V/count * A/Vr / Vo/Vr
    .fast_loop_param.adc2_gain = 3.0/4096/(.2), //3.3/4096*(.2),
    .fast_loop_param.adc3_gain = 3.0/4096/(.2), //3.3/4096*(.2), 
