...
const volatile Param __attribute__ ((section ("flash_param"))) param_store = {
    ...
    .fast_loop_param.foc_param.pi_d.command_max=22,
    ...
    .startup_param.startup_mode = TORQUE,
    ...
    .main_loop_param.torque_sensor.bias = .415,
    ...
    .main_loop_param.torque_controller_param.torque.kp = 20,
