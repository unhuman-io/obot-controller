...
const volatile Param __attribute__ ((section ("flash_param"))) initial_param = {
    ...
    .fast_loop_param.foc_param.pi_q.ki=0.001,
    ...
    .fast_loop_param.adc1_gain = -3.3/4096/(.005*20),  // V/count * A/Vr / Vo/Vr (3.3/4096 / R / Gain)
    .fast_loop_param.adc2_gain = -3.3/4096/(.005*20),
    .fast_loop_param.adc3_gain = -3.3/4096/(.005*20), 
    .fast_loop_param.motor_encoder.dir = 1,
    .fast_loop_param.phase_mode = 1,
    .fast_loop_param.motor_encoder.cpr = 262144,
