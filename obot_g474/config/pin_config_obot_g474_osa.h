...
void pin_config_obot_g474_osa() {
    ...
    // Sleep mode enable
        ...
        // spi 1
        GPIO_SETL(A, 4, GPIO_MODE::OUTPUT, GPIO_SPEED::MEDIUM, 0);   // SPI1 CS
        GPIO_SETL(A, 5, GPIO_MODE::ALT_FUN, GPIO_SPEED::MEDIUM, 5);   // SPI1 CLK
        GPIO_SETL(A, 6, GPIO_MODE::ALT_FUN, GPIO_SPEED::MEDIUM, 5);   // SPI1 HIDO (host in device out)
        GPIO_SETL(A, 7, GPIO_MODE::ALT_FUN, GPIO_SPEED::MEDIUM, 5);   // SPI1 HODI
        ...
        // spi 3
        GPIO_SETH(C, 10, GPIO_MODE::ALT_FUN, GPIO_SPEED::MEDIUM, 6);   // SPI3 CLK
        GPIO_SETH(C, 11, GPIO_MODE::ALT_FUN, GPIO_SPEED::MEDIUM, 6);   // SPI3 HIDO
        GPIO_SETH(C, 12, GPIO_MODE::ALT_FUN, GPIO_SPEED::MEDIUM, 6);   // SPI3 HODI 
