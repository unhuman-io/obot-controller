...
const volatile Param
    __attribute__((section("flash_param"))) param_store = {
        ...
        .main_loop_param.torque_sensor.gain = 2 * 4.717 / pow(2, 24) * 100,
        .main_loop_param.torque_sensor.bias = -.9,
        ...
        .main_loop_param.position_controller_param.position
            .velocity_filter_frequency_hz = 400,
        ...
        .main_loop_param.torque_controller_param.torque
            .velocity_filter_frequency_hz = 50,
        .main_loop_param.torque_controller_param.torque
            .output_filter_frequency_hz = 1000,
        ...
        .main_loop_param.impedance_controller_param.impedance
            .velocity_filter_frequency_hz = 500,
        ...
        .main_loop_param.impedance_controller_param.torque
            .velocity_filter_frequency_hz = 0,
        .main_loop_param.impedance_controller_param.torque
            .output_filter_frequency_hz = 0,
        ...
        .main_loop_param.velocity_controller_param.velocity
            .velocity_filter_frequency_hz = 400,
        .main_loop_param.velocity_controller_param.velocity
            .output_filter_frequency_hz = 400,
        ...
        .drv_regs =
            {
                ...
                (4 << 11) |
                    0x37F,  // ls_reg      0x0CC, no cycle by cycle, 4000 ns
                            // tdrive moderate drive current (.57,1.14A)
                (5 << 11) | 0x000,  // ocp_reg     0x00 -> 50 ns dead time,
                // latched ocp, 2 us ocp deglitch, 0.06 Vds thresh
                (6 << 11) |
                    0x240,  // csa_reg     0x240 -> bidirectional current, 10V/V
            },
...
const Param* const param =
    &param_store;  // todo figure out a way to not inline without warning
