...
#include "param_motor.c"
    ...
    .main_loop_param.admittance_controller_param.velocity.velocity.ki = 300,
    .main_loop_param.admittance_controller_param.velocity.velocity.kp = 3,
    .main_loop_param.admittance_controller_param.velocity.velocity.ki_limit = 8,
