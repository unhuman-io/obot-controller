...
const volatile Param
    __attribute__((section("flash_param"))) param_store = {
        ...
        .fast_loop_param.motor_encoder.cpr =
            1. / 10.e-6 * 2. * M_PI,  // counts per mm * (2*pi)
        ...
        .main_loop_param.velocity_controller_param.velocity
            .velocity_filter_frequency_hz = 0,
        .main_loop_param.velocity_controller_param.velocity
            .output_filter_frequency_hz = 100,
        ...
        .drv_regs =
            {
                ...
                //(4<<11) | 0x2FF, // ls_reg      0x0CC, no cycle by cycle, 500
                //ns tdrive
                ...
                (6 << 11) |
                    0x2C0,  // csa_reg     0x2C0 -> bidirectional current, 40V/V
                            //(6<<11) | 0x280,
                //(6<<11) | 0x240, // csa_reg     0x240 -> bidirectional
                //current, 10V/V
            },
        .name = "ms",
