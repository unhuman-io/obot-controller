...
const volatile Param __attribute__((section("flash_param"))) param_store = {
    ...
    .main_loop_param.position_controller_param.position
        .velocity_filter_frequency_hz = 1000,
    ...
    .main_loop_param.torque_controller_param.torque.output_filter_frequency_hz =
        0,
    ...
    .drv_regs =
        {
            ...
            //(4<<11) | 0x2FF, // ls_reg      0x0CC, no cycle by cycle, 500 ns
            //tdrive
            // moderate drive current (.57,1.14A)
            (4 << 11) | 0x37F,  // ls_reg      0x0CC, no cycle by cycle, 4000 ns
            ...
            //(6<<11) | 0x2C0, // csa_reg     0x2C0 -> bidirectional current,
            //40V/V
            //(6<<11) | 0x280,
            (6 << 11) |
