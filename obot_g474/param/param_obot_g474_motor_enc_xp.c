...
const volatile Param __attribute__ ((section ("flash_param"))) param_store = {
    ...
    .fast_loop_param.motor_encoder.index_electrical_offset_pos = -820 - (-1666),
    ...
    .main_loop_param.position_controller_param.velocity_limit = 25,
    .main_loop_param.position_controller_param.desired_filter_hz = 40,
    .main_loop_param.position_controller_param.position.ki_limit = 10,
    ...
    .main_loop_param.output_encoder.bias = -2.502,
...
//#include "tab.csv"
    ...
    .main_loop_param.encoder_limits.motor_controlled_max = .03*20.25,
    .main_loop_param.encoder_limits.motor_controlled_min = -1.6*20.25,
    .main_loop_param.encoder_limits.motor_hard_max = .095*20.25,
    .main_loop_param.encoder_limits.motor_hard_min = -1.7*20.25,
    .main_loop_param.encoder_limits.output_hard_max = .095,
    .main_loop_param.encoder_limits.output_hard_min = -1.7,
    .name = "left_hip_pitch",
