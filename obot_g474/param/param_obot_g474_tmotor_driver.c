...
.fast_loop_param.foc_param.pi_d.kp=.25, // no vbus measurement
...
.main_loop_param.velocity_controller_param.velocity.ki = 10,
.main_loop_param.velocity_controller_param.velocity.kp = .1,
.main_loop_param.velocity_controller_param.velocity.ki_limit = 3,
.main_loop_param.velocity_controller_param.velocity.velocity_filter_frequency_hz = 200,
