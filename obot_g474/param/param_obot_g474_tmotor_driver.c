...
.fast_loop_param.adc1_gain = -3.3/4096/(.0033*10*1.0),  // A/count,
.fast_loop_param.adc2_gain = -3.3/4096/(.0033*10*1.0),
.fast_loop_param.adc3_gain = -3.3/4096/(.0033*10*1.0),
...
.main_loop_param.velocity_controller_param.velocity.ki_limit = 10,
...
.main_loop_param.joint_position_controller_param.velocity.velocity.ki_limit = 10,
...
.main_loop_param.joint_position_controller_param.velocity.velocity.command_max = 10,
...
.startup_param.phase_lock_current = 8,
