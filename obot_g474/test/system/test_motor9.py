...
time.sleep(.1)
check_var_regex("mcmd_result", r"last command: 0xb1, current command: 0x(00|b1), result: 0x(00|80)")
check_var("mreadj_dig", "ok")
time.sleep(2)
check_var_regex("mcmd_result", r"last command: 0xb2, current command: 0x(00|b2), result: 0x(00|80)")
